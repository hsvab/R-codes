...
# c<classificação> – para especificar as classificações da tabela e suas categorias desejadas especificar
...
# Para mais exemplos e tipos de gráficos em http://jkunst.com/highcharter/